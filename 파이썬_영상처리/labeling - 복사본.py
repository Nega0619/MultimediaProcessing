...
def showLabel(oriImg, bImg, labelimg):
    showL=labelimg.copy()
    num_label=labelimg.max()
    step=255//num_label
    showL=showL*step
    return oriImg,bimg,showL
...
def selectObject(oriImg, labelimg, selectNo):
    ...
    #detect Outline and add origin Image
def thickenOutline(img):
    outlineImg = detection_edge_morphology(Image, 3, 1)
    result=img+outlineImg
...
if __name__ == '__main__':
    ...
    origin, binOri, labOri =showLabel(Image, bimg, labelimg)
    ...
    #after processing
    #afterImg_4=morp_close(bimg,kernel_4)

    #showImage
    #showLabel(Image, bimg, labelimg, result,bimg2,labelimg2)

    
    origin, binOri, labOri =showLabel(Image, bimg, labelimg)
    origin2, binOri2, labOri2 =showLabel(Image, bimg2, labelimg2)
    
    showNImage(origin, binOri, labOri,origin2, binOri2, labOri2)
...
'''
    ...
    kernel_4=np.array([[0,1,0],
                       ...
                       [0,1,0]])
    #preprocessing img
    result = thickenOutline(Image)

    #binarize
    bimg2=binarization(result,80)

    labelimg2=label_scipy(bimg2)
'''
